...
import { AITutorSuggestionPage } from './AITutorSuggestionPage';
...
export function FindTutorPage({ onViewTutorProfile, onBookingSuccess }: FindTutorPageProps) {
